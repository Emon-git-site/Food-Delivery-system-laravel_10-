        ...
        <div class="slider-bg">
            <div class="slider-item">
                <div class="image">
                    ...
                    <img src="main-img object img-fluidimg/baner/banner.jpg" alt="Image not Found" class="img-fluid">
                </div>
                <div class="love-icon">
                    <!-- Place your small background image here-->
                    <img src="main-img object img-fluidimg/icon/banner_image_1.png" class="love-1 object img-fluid" data-value="5" alt="Image not Found">
                    <img src="main-img object img-fluidimg/icon/banner_image_3.png" class="love-3 object img-fluid" data-value="-3" alt="Image not Found">
                    <img src="main-img object img-fluidimg/icon/welcome_image.png" class="love-2 object img-fluid" data-value="-8" alt="Image not Found">
                </div>
