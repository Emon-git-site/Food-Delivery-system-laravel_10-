                                            ...
                                            <div class="col-md-6 col-sm-6 col-12">
                                                <div class="product-list-inner">
                                                    ...
                                                    <div class="recipes-details">
                                                        ...
                                                        <div class="cat-name-top-recipes">{{ $top->subcategory->subcategory_name }}</div>
 
                                                        <p class="price pt-2">
                                                            @if($top->discount_price>0)
                                                            <del>{{ $website_setting->currency }}{{ $top->price }}</del> {{ $website_setting->currency }}{{ $top->discount_price }}
                                                            @else
                        ...
                        <div class="row"> 
                            <div class="col-lg-12">
                                <ul class="portfolio__menu">
                                    ...
                                    @foreach ($subcategories as $subcategory)
                                    <li><button class="menu" type="button" data-filter=".product-{{ $subcategory->id }}">{{ $subcategory->subcategory_name }}</button></li>
                                    @endforeach
                                    ...
                                    <div class="product-inner">
                                        <div class="pruct-img-sec">
                                            <div class="product-img">
                                                <img src="http://127.0.0.1:8000/{{ $row->image }}" alt="Image not found" class="pd-image">
                                            </div>
                                            <div class="product-details">
                                                ...
                                                <p class="price pt-2">
                                                    ...
                                                    <del>{{ $website_setting->currency }}{{ $row->price }}</del> {{ $website_setting->currency }}{{ $row->discount_price }}
                                                    @else
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="brand-wrap">
                                                                ...
                                                                <img src="{{ asset('frontend') }}/https://demo2wpopal.b-cdn.net/poco/wp-content/uploads/2020/08/trust-symbols.png" data-src="{{ asset('frontend') }}/" class="image-responsive lazyloaded">
                                                            </div>
