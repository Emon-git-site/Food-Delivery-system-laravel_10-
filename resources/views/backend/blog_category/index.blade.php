                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('category.index') }}">Blog Category</a></li>
    ...
    // data tale data show
        function initializeDataTable() {
            ...
            var table = $('#example1').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('blogCategory.blogCategoryShow') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex'
                    },
        ...
        $(document).ready(function() {
            $('body').on('click', '.edit_modal', function() {
                let id = $(this).data('id');
                let url = "{{ url('blogCategory/edit') }}/" + id;
                $.ajax({
                    url: url,
                    type: 'get',
                    success: function(response) {
        ...
        $(document).ready(function() {
            ...
            $('#update_form').submit(function(e) {
                ...
                let url = "{{ url('blogCategory/update') }}/" + category_id;
                let data = {
