                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('admin.blogCategory.index') }}">Blog Category</a></li>
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('admin.blogCategory.store') }}" method="post" id="add_form">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="blogcategory_name" name="blogcategory_name" required>
                        </div>
                    ...
                    <form action="" method="post" id="update_form">
                        ...
                        <div class="mb-3">
                            ...
                            <label for="blogcategory_name_update" class="form-label">Category Name <span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="blogcategory_name_update" name="blogcategory_name_update"
                                required>
                        </div>
